        ...
        if(startPlaying){
            ...
            if(round <=2){
                ...
                setTimeout(function(){
                    ...
                    // invoke a function to get the current score.
                    getScore("user");
                    getScore("computer"); 
                    },2700);
                ...
                function getScore(player){
                    ...
                    if(player === "user"){
                        ...
                        //total score will be calculated each round.     
...
//tabs - instruction, rules have [hide] to toggle the slide up and down.
const $tab01 =$('.tab01');
const $tab02 = $('.tab02');
